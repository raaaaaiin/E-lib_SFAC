...
@section('content')
        ...
        <div class="tab-pane active" id="details">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6">
                        <div
                            class="form-group required label-floating  {{ $errors->has('db.host') ? 'has-error': '' }}">
                            ...
                            @if($errors->has('db.host'))
                                <span class="help-block error">{{ ($errors->first('db.host')) }}</span>
                            @endif
                        </div>

                        <div
                            class="form-group required label-floating {{ $errors->has('db.username') ? 'has-error': '' }}">
                            ...
                            @if($errors->has('db.username'))
                                <span class="help-block error">{{ ($errors->first('db.username')) }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div
                            class="form-group required label-floating  {{ $errors->has('db.port') ? 'has-error': '' }}">
                            ...
                            @if($errors->has('db.port'))
                                <span class="help-block error">{{ ($errors->first('db.port')) }}</span>
                            @endif
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div
                            class="form-group required label-floating {{ $errors->has('db.database') ? 'has-error': '' }}">
                            ...
                            @if($errors->has('db.database'))
                                <span class="help-block error">{{ ($errors->first('db.database')) }}</span>
                            @endif
                        </div>
                    </div>
                ...
                {{--                            <span class="help-block error">{{ ($errors->first('admin.first_name')) }}</span>--}}
                {{--                        @endif--}}
                {{--                    </div>--}}
                {{--                </div>--}}
                {{--                <div class="col-sm-6">--}}
                ...
                {{--                            <span class="help-block error">{{ ($errors->first('admin.last_name')) }}</span>--}}
                {{--                        @endif--}}
                {{--                    </div>--}}
                {{--                </div>--}}
                ...
                {{--                            <span class="help-block error">{{ ($errors->first('admin.username')) }}</span>--}}
                {{--                        @endif--}}
                {{--                    </div>--}}
                {{--                </div>--}}
                {{--                <div class="col-sm-6">--}}
                ...
                {{--                            <span class="help-block error">{{ ($errors->first('admin.email')) }}</span>--}}
                {{--                        @endif--}}
                {{--                    </div>--}}
                {{--                </div>--}}
                ...
                {{--                            <span class="help-block error">{{ ($errors->first('admin.password')) }}</span>--}}
                {{--                        @endif--}}
                {{--                    </div>--}}
                {{--                </div>--}}
                {{--                <div class="col-sm-6">--}}
                ...
                <div class="col-sm-12">
                    <div class="col-sm-4">
                        <div
                            class="form-group required label-floating {{ $errors->has('site.site_name') ? 'has-error': '' }}">
                            <label class="control-label" for="site-name">Site Name <span>*</span></label>
                            <input type="text" name="site[site_name]" value="{{ old('site.site_name',"LmsMng") }}"
                                   id="site-name" class="form-control">
                            @if($errors->has('site.site_name'))
                                <span class="help-block error">{{ ($errors->first('site.site_name')) }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div
                            class="form-group required label-floating {{ $errors->has('site.site_url') ? 'has-error': '' }}">
                            <label class="control-label" for="site_url">Site URL <span>*</span></label>
                            <input type="text" name="site[site_url]"
                                   value="{{ old('site.site_url',request()->getSchemeAndHttpHost()) }}" id="site_url"
                                   class="form-control">
                            @if($errors->has('site.site_url'))
                                <span class="help-block error">{{ ($errors->first('site.site_url')) }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div
                            class="form-group required label-floating {{ $errors->has('site.site_email') ? 'has-error': '' }}">
                            <label class="control-label" for="site-email">Site Email <span>*</span></label>
                            <input type="text" name="site[site_email]"
                                   value="{{ old('site.site_email',"noreply@".request()->getHttpHost()) }}"
                                   id="site-email" class="form-control">
                            @if($errors->has('site.site_email'))
                                <span class="help-block error">{{ ($errors->first('site.site_email')) }}</span>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    <div class="wizard-footer">
        <div class="pull-right">
            <button type="submit" name='next' class="btn btn-next btn-fill btn-danger btn-wd install-button"><i
                    class="fa fa-refresh fa-spin"></i> Save & Install
            </button>

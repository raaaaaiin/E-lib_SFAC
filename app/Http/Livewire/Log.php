...
class log extends Component
{
    ...
    protected $listeners = ["data_manager","cancelRequest","test","saveRemarks","logbackdata_manager","mountclear"];


     public function logbackdata_manager($datas)
{
    ...
    public function verify($datas){
     ...
     $this->decrypt = hex2bin($datas);
      $this->mount($this->decrypt);
      $this->sendMessage(__("Welcome back!"), "success");
     }
    }
    ...
    public function mountclear()
    {
       ...
       $this->user_id = "";
        ...
        $this->name = "";
            ...
            $this->privacyborrow = "";
            $this->privacyprofile = "";
            $this->privacyleaderboard = "";
            $this->privacyfuture = "";
            $this->generalprivacy = "";
            $this->systempermission ="";
            $this->currentlyBorrowed = [];
            $this->currentlyRemarks = [];
              $this->roles = [];
    $this->section = [];
          $this->photo_link = asset("uploads/default.jpeg",false);
    ...
    $this->loadCurrentlyRemarks();
     ...
     $user = User::where("id", $this->user_id)->get();
        ...
        return view('livewire.Log',['merged_post' => $merged_post])->section('content');;
    }
